...
public class Arrays01 {
	...
	public static void main(String[] args) {
		...
		// 새로 복제된 객체에 있는 static이 아닌 
		// bb() method를 호출(사용)할 수 있고
		a.bb();
		
		// Arrays01에 포함된 MyBook inner class를 사용할 때는
		// 먼저 Arrays01을 별도로 객체로 생성(복제)하여
		// 그 객체로 부터 new 키워드를 호출 사용해야 inner class를 사용할 수 있다.
